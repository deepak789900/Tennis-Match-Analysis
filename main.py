...
def main():
    ...
    save_video(output_video_frames, "output_video/output_video01.avi")
    display_video(output_video_frames,"Video",fps=70,width=1280,height=580)
    ...
    print(player_stats_data_df.head())

    player_stats_data_df.to_json("output/player_stats.json", orient="records")

    test_data = pd.read_json("output/player_stats.json")
    print(test_data.head())

    player_stats_data_df.to_json("player_stats.json", orient="records", lines=True)
...
if __name__ == "__main__":
    main()
    print("Creating the Player's Pannel ....")
    run_flask_app()
